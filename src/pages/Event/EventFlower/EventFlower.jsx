...
const PLACEMENT_DETAILS = {
  'Welcome Board': {
    size: '10x12 ft',
    sqFt: '120 sq ft',
    notes: 'Standard placement at the main entrance. Ensure lighting is directed towards the center of the board.',
    elements: 'Vinyl print on 3mm foam board with matte finish. Reinforced wooden frame backing.',
  },
  'Entry Gate': {
    size: '8x10 ft',
    sqFt: '80 sq ft',
    notes: 'Position at the main entry point. Confirm structural anchoring before installation.',
    elements: 'Powder-coated metal frame with fabric backdrop and LED trim.',
  },
  Props: {
    size: '4x4 ft',
    sqFt: '16 sq ft',
    notes: 'Distribute evenly across the venue based on the floor plan. Handle with care during transport.',
    elements: 'Mixed foam and resin props with a hand-painted finish.',
  },
  'Artiste Stage Platform': {
    size: '20x16 ft',
    sqFt: '320 sq ft',
    notes: 'Set up on a level, non-slip surface. Verify weight capacity before the artiste takes the stage.',
