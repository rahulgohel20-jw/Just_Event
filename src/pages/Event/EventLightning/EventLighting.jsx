...
// This page only ever shows the lighting inventory category.
const INVENTORY_ITEMS_FILTER = 'LIGHTING';
// TODO: confirm the real rawCategoryId for Lighting against RawItemMaster —
// 16 was Flowers' id, this is a placeholder until confirmed.
const LIGHTING_RAW_CATEGORY_ID = 17;
...
const EventLighting = () => {
  ...
  const fetchLightingCatalogItems = useCallback(
    async (query) => {
      try {
        ...
        console.error('Failed to fetch lighting catalog items:', err);
        return [];
      }
    },
    [userId]
          ...
          <div className="mt-4 flex flex-col gap-3 rounded-2xl bg-primary-lighest p-3 sm:flex-row sm:items-center">
            <div className="relative flex-1">
              ...
              <AsyncSearchSelect
                ...
                fetcher={fetchLightingCatalogItems}
                value={catalogPick}
