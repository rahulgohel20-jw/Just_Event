...
const PaymentDetails = ({
  ...
  const addPayment = () => {
    onPaymentsChange([
      ...payments,
      {
        id: Date.now(), // client-only temp id, same convention as EstimateItems
        amount: "",
        mode: "Bank Transfer",
        date: "",
        description: "",
      ...
      <div className="w-full py-2 px-5 flex justify-between">
        <div className="flex gap-5 text-xs">
          ...
          <button
            onClick={onSave}
            disabled={saving}
            className="border border-primary-clarity rounded-lg px-6 py-2 text-gray-900 font-semibold disabled:opacity-60"
          >
