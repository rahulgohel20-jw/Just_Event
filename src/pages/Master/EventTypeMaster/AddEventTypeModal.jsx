...
const AddEventTypeModal = ({ open, onClose, onSave, initialData }) => {
  ...
  useEffect(() => {
    if (open && initialData) {
      setEventTypeName(
        initialData.nameEnglish || initialData.categoryName?.english || ""
      );
      setTypeImagePreview(
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div
              ...
              className={`min-h-[180px] rounded-xl border-2 border-dashed p-6 text-center transition-colors ${
                isDragging
